...
public:
    ...
    double IntensityAt(double r_au, double z_au) const;
    double GouyPhase(double r_au, double z_au) const;
    double FocalPhase(double r_au, double z_au) const;
    double Phase(double r_au, double z_au) const;
